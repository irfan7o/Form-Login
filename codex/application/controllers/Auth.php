...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        $this->form_validation->set_rules('password1', 'Password', 'required|trim|min_length[3]|matches[password2]', ['matches' => 'Password do not match!', 'min_length' => 'Password is too short!']);
        ...
        if ($this->form_validation->run() == false) {
            ...
            Success! Please check your email and activation your account :)</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'mdkcoz0@gmail.com',
            'smtp_pass' => 'joenkz2340',
            'smtp_port' => 465,
            'smtp_crypto' => 'ssl',
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
        ...
        $this->email->from('mdkcoz0@gmail.com', 'mdk coz');
